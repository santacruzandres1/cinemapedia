...
Id _movieGetId(Movie object) {
  return object.idsaId ?? Isar.autoIncrement;
}
...
extension MovieQueryWhereSort on QueryBuilder<Movie, Movie, QWhere> {
  QueryBuilder<Movie, Movie, QAfterWhere> anyIdsaId() {
...
extension MovieQueryWhere on QueryBuilder<Movie, Movie, QWhereClause> {
  QueryBuilder<Movie, Movie, QAfterWhereClause> idsaIdEqualTo(Id idsaId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterWhereClause> idsaIdNotEqualTo(Id idsaId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
              IdWhereClause.lessThan(upper: idsaId, includeUpper: false),
            )
            .addWhereClause(
              IdWhereClause.greaterThan(lower: idsaId, includeLower: false),
            );
      } else {
        return query
            .addWhereClause(
  ...
  QueryBuilder<Movie, Movie, QAfterWhereClause> idsaIdGreaterThan(Id idsaId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.greaterThan(lower: idsaId, includeLower: include),
      );
    });
  }

  QueryBuilder<Movie, Movie, QAfterWhereClause> idsaIdLessThan(Id idsaId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.lessThan(upper: idsaId, includeUpper: include),
      );
    });
  }

  QueryBuilder<Movie, Movie, QAfterWhereClause> idsaIdBetween(
    Id lowerIdsaId,
    Id upperIdsaId, {
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> idsaIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> idsaIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> idsaIdEqualTo(Id? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'idsaId',
        value: value,
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> idsaIdGreaterThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> idsaIdLessThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> idsaIdBetween(
    Id? lower,
    Id? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenByIdsaId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idsaId', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenByIdsaIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idsaId', Sort.desc);
    });
  }
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  QueryBuilder<Movie, int, QQueryOperations> idsaIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'idsaId');
    });
  }
